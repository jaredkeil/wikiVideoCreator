...
def main(args):
    ...
    for title in titles:
        movie = WikiMovie(title, args.narrator, parse_narrator_args(args), parse_downloader_args(args), args.overwrite)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--n_pages', type=int, default=25, help='number to process from url')
    ...
    # WikiMovie/ImageDownloader object arguments
    narrator_args = parser.add_argument_group('narrator arguments (optional)')
